...
public partial class RobotTabView : UserControl
{
    ...
    private void EditorOnTextChanged(object? sender, EventArgs e)
    {
        try
        {
            ...
            if (DataContext is RobotTabViewModel viewModel)
    ...
    private void ViewModelOnPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        try
        {
            ...
            if (e.PropertyName is nameof(RobotTabViewModel.Code))
